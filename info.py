...
PICS = (environ.get('PICS', 'https://i.ibb.co/ym7N47X6/1296482719-28588.jpg')).split()  # Sample pic
...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.ibb.co/q3T9NWjT/1296482719-28590.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1296482719').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003337417077 -1003703513064').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003800962005'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003337417077'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003779766425'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003800962005'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1003708952638')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1003708952638').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1003708952638').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '6361544087-3@ybl')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Nandi177</b>")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb://nandishs177_db_user:Nandishs17@ac-rm8h8wp-shard-00-00.mqvhjgv.mongodb.net:27017,ac-rm8h8wp-shard-00-01.mqvhjgv.mongodb.net:27017,ac-rm8h8wp-shard-00-02.mqvhjgv.mongodb.net:27017/?ssl=true&replicaSet=atlas-kmzupv-shard-0&authSource=admin&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/KNMoviesdiscussion/16')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c1b32d25a37d181f117464d8a9ca962162229732')
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KNMoviesHub17')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KNMoviesHub17')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Nandi177')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/KNMoviesHub17')
OWNERID = int(os.environ.get('OWNERID', '1296482719'))  # Replace with the actual admin ID
