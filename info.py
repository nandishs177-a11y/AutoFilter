...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003703513064 -1003965891384').split()]  # Channel id for auto indexing (make sure bot is admin)
...
VERIFY = environ.get('VERIFY', 'True') == 'False'
